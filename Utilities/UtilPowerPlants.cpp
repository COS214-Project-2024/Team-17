...
UtilPowerPlants::UtilPowerPlants() {
	// TODO - implement UtilPowerPlants::UtilPowerPlants
...
void UtilPowerPlants::shutDown() {
	// TODO - implement UtilPowerPlants::shutDown
	throw "Not yet implemented";
}

void UtilPowerPlants::restart() {
	// TODO - implement UtilPowerPlants::restart
	throw "Not yet implemented";
}
