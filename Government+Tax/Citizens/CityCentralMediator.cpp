...
void CityCentralMediator::notifyUtilityChange(UtilityType type, bool status) {
	// TODO - implement CityCentralMediator::notifyUtilityChange
	throw "Not yet implemented";
}

void CityCentralMediator::notifyRoadChange(RoadStatus status) {
...
void CityCentralMediator::handleTrafficStatus(TrafficStatus status) {
